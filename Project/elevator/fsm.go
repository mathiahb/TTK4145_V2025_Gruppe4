...
func InitFSM(portElevio int, localElevator Elevator, elevatorChannels ElevatorChannels, toSharedState shared_states.FromElevator, isStuckTimer *time.Timer) Elevator {
