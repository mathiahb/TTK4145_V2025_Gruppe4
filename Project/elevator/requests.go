...
func requestsClearAtCurrentFloor(localElevator Elevator, hallRequests HallRequestType, ClearHallRequest chan HallRequestType, updateStateChannel chan Elevator) (Elevator, HallRequestType) {
